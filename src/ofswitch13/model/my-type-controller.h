...
#ifndef MY_TYPE_CONTROLLER_H
#define MY_TYPE_CONTROLLER_H
namespace ns3 {
/**
 * \ingroup ofswitch13
 * \brief An Learning OpenFlow 1.3 controller (works as L2 switch)
 */
class MyTypeController : public OFSwitch13Controller
{
public:
  MyTypeController ();          //!< Default constructor
  virtual ~MyTypeController (); //!< Dummy destructor.
