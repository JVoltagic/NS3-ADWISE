...
#ifndef RSU4CONTROLLER_H
#define RSU4CONTROLLER_H
namespace ns3 {
/**
 * \ingroup ofswitch13
 * \brief An Learning OpenFlow 1.3 controller (works as L2 switch)
 */
class RSU4controller : public OFSwitch13Controller
{
public:
  RSU4controller ();          //!< Default constructor
  virtual ~RSU4controller (); //!< Dummy destructor.
